...
var listenerFunction = {
    ...
    checkPassword: (ev) =>{
        ...
        if(!content){
            ...
            error = 'Your password must contain at least one upper case letter, one lower case letter, one number \
            and one special character and be between 8 and 20 characters long.'
        }
